...
public partial class MainForm
{
    ...
    private Panel CreateMemberGridPanel()
    {
        ...
        // Search bar - search label 150px, buttons 200px each, search box takes remaining space
        ...
        searchPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 200)); // Export
        searchPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 200)); // Badge PDF
        searchPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 200)); // Select All
        searchPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 200)); // Batch Badges
